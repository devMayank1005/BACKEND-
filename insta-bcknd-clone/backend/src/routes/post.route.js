...
, likePostController, unLikePostController, addCommentController, getCommentsController, getFeedcontroller
...
postRouter.post('/:postId/comments', identifyUser, addCommentController);
postRouter.get('/:postId/comments', identifyUser, getCommentsController);
